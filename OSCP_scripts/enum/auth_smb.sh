...
## 3) Modules
MODULES=(laps gpp_password gpp_autologin wifi putty powershell_history lsassy nanodump mremoteng notepad++ winscp vnc wifi reg-winlogon rdcman backup_operator)
LOCAL_ADMIN_MODULES=(sam lsa lsass ntds gmsa)
